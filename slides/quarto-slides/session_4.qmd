...
:::notes
QUE: is this how the folder really looks? check! (with background images for reading). probably. copy entire experiment folder for OS as well
:::
...
:::notes
QUE: check here about the folder and subfolders. see above
:::
...
:::notes
QUE: time-out? (TIME event offset + blank instead of target_offset trigger). several TWs - then several periods
What about adding 200ms from the onset or smth? (yes).
Is it correct to set TW before visual check? YES.
:::
...
:::notes
QUE: kids blink more? yes. noisy data. vwp no established criterion how to clean. should be standard for all?
:::
...
:::notes
QUE: yes, stop merging option. Espe never does anything of this. We don't recommend anything, we give options.
:::
...
:::notes
QUE: is this specific for the binning report? probably yes.
:::
...
:::notes
QUE: overall increased attention - but still analyzed per IA so why? they look more at pictures than screen in general. they still look more at 1 picture than at the other but Magnitude of effect differs depending on report
:::
...
:::notes
QUE: wym by keep AIs? where? data filters (show IA) - BEFORE TIME WINDOW!!!
:::
