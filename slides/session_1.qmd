...
-   As opposed to offline measures (e.g., questionnaires) - Converging evidence
...
These properties impact data quality[^3].

[^3]: It also depends on participant-specific properties, more on this in session 5.
...
-   Relatively expensive.
    ...
    -   In terms of time: one participant at a time[^4].
-   Trade-off between accuracy and ecological validity.
-   Participants' criteria.

[^4]: Dual eye-tracking experiments are being done!
