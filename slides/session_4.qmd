...
![](images/session_6/projdir1.JPG){fig-align="center"}

## Raw data

Data directory (eye data & behavioural data)

![](images/session_6/projdir2.JPG){fig-align="center"}
...
![](images/session_6/asciii1.JPG){fig-align="center"}
...
![](images/session_6/asciii2.png){fig-align="center"}
...
::: {.column width="50%"}
![](images/session_6/8.png){fig-align="center"}

![](images/session_6/20.png){fig-align="center"}
:::
:::
...
::: {.column width="50%"}
![](images/session_6/34.png){fig-aling="center"}
:::
:::
...
![](images/session_6/ex_loglab.JPG){fig-align="center"}
...
![](images/session_6/reading_cleaning_logbook.png){fig-align="center"}

## Exporting

Prepare data to be analysed elsewhere (e.g., R, SPSS) Data Viewer has different reports.

![](images/session_6/9.png)

# Data Viewer

## Interface

![](images/session_6/viewing_dv1.JPG)

## Interface

![](images/session_6/viewing_dv2.jpg)

## Interface

Time window of analysis

![](images/session_6/25.png){fig-align="center"}
...
::: {.column width="50%"}
![](images/session_6/29.png){fig-align="center"}
:::
:::
...
::: {.column width="50%"}
![](images/session_6/33.png)

![](images/session_6/32.png)
:::
:::
...
![](images/session_6/31.png){fig-align="center"}
...
::: {.column width="50%"}
![](images/session_6/dv_filter.JPG){height="500px"}
:::
:::
...
-   Only samples on IAs, or also including on-screen but not on IAs?
    -   Trade-off.
    - Affects how _proportions_ are calculated
...
- Exclude Samples during Saccade and Exclude Bins that Contains Non-Fixation Samples

Not straightforward answer.

## Example data pre-processing

![Knoeferle & Crocker, 2006](images/session_6/knoerfele1.JPG){fig-align="center"} ![Arantzeta et al., 2017](images/session_6/basque.JPG){fig-align="center"} ![Apfelbaum et al., 2021](images/session_6/names.JPG){fig-align="center"}
...
![](images/session_6/11.png){fig-align="center"}
...
Information duplicated per Interest Area. If you have two visuals, then two; three visuals, then three, and so on (*IA_x*).

-   IA_1_ID, IA_2_ID and so on: The label of the item that was presented in that region (target/distractor).
- SAMPLE_COUNT: The number of samples per bin
- 
-   RIGHT_IA_1_SAMPLE_COUNT, RIGHT_IA_2_SAMPLE_COUNT and so on: The number of fixations that fell in that area per bin (out of the number of samples per bin, i.e., if each bin has 10 samples, then it's out of ten).
