...
format: 
   clean-revealjs:
    ...
    footer: "Introduction to eye-tracking I "
    include-in-header: 
      text: |
        <style>
        .center-xy {
...
What eye to track? - Dominant eye (by default, right eye)
...
(Syntactic) constructions = grammatical patterns/rules. They differ in productivity (= number of different lexical items they can be used with). 
If productivity is high, there are many possible continuations that a sentence containing this construction can have (example: "He started to..."). 
If productivity is low, there are very few possible continuations (example: "He burst into... ").
...
::: {layout-ncol="2"}
![](images/session_1/reading_resultsV.png){fig-align="center" height="500px"}

![](images/session_1/reading_resultsINF.png){fig-align="center" height="500px"}
:::
