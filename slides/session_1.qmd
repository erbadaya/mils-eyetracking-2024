...
5. How does an eye-tracking experiment look like?
...
How do you think these measures can be used in language research?
...
## How does an eye-tracking experiment look like?
...
![](images/session_2/lab_setup2.jpg){fig-align="center"}
...
Host PC and camera are connected and synchronized.
Host PC and Presentation PC are connected and synchronized.
...
-   Ensure they are sitting comfortably.
    -   Not hunching.
    -   Not stretching their necks.
        -   To avoid pain & small head movements.
-   Show them the eye being tracked.
...
![](images/session_2/host_pc_setup.JPG)
...
![](images/session_2/eye_undetected.JPG){height="300px"}

:::
:::{.column width="50%"}

![](images/session_2/eye_detected.JPG){height="300px"}
...
![](images/session_2/unfocused_camera.JPG){height="300px"}
...
![](images/lab_setup/good_captureeye1.png)
![](images/lab_setup/good_pupil.png)
...
![](images/session_2/options.jpg){height="550px"}
:::
:::
...
-   Eyelids
    -   Cover the pupil is lower gaze directions
    -   An issue in some cases (e.g., tired participants)
    -   Recording from lower than useful.
...
-   Glasses
    ...
    -   Move camera (angle rather than distance)
        -   Place reflections far awar from pupil and CR
    -   Move mirror (only possible in tower-mounted eye-trackers)

## Camera set up: Issues

-   Contact lenses
    -   Air bubles between eye and contact lense interact with CR
        -   Camera focus
-   Wet eyes
    -   Split up the CR
        -   Breaks
...
x,y coordinates of gaze position is estimated from measuring the pupil and the CR on known coordinates (i.e., the calibration points).
...
-   Fixate on a series of points
    -  \# points \~ accuracy
        -   9HV standard
        -   Smaller AOIs need more calibration points
...
-   Should cover area where stimuli are presented
...
-   How can we make sense out of the data after the experiment?
  - Areas of Interest
  - Triggers
...
-   Ensure accuracy
-   Where the drift appears depends on your task.
...
![Drift single sentence reading](images/lab_setup/drift_reading.jpg){height=500px}

:::
:::{.column width="50%"}

![Drift VWP](images/lab_setup/drift_vwp.jpg){height=500px}
...
![Single sentence reading](images/session_2/ia_reading.png){height="200px"  fig-align="center"} 

:::
:::{.column width="50%"}

![VWP](images/session_2/ia_vwp.png){height="300px" fig-align="center"}
...
- In the latter case, ROIs might not be known in advance.
...
Particularly relevant for gaze contingent paradigms too!
...
See also Rodriguez Ronderos et al. (2018) - Eye Tracking During Visually Situated 
Language Comprehension: Flexibility and Limitations in Uncovering Visual 
Context Effects
