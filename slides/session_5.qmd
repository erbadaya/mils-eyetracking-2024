...
Has anyone gotten around their data?
...
-   Last week: Data checks & cleaning in Data Viewer
...
-   RIGHT_IA_X_SAMPLE_COUNT\_%, where X is the number of the interest area (NB LEFT/RIGHT).
- sample_count
- BLINK_IN_SAMPLE/SACCADE_IN_SAMPLE
:::
...
![](images/session_7/scanpath.png){fig-align="center"}

## Bee swarm

![](images/session_7/beeswarm.png){fig-align="center"}

## Heat map

![](images/session_7/heatmap.png){fig-align="center"}
...
![](images/session_7/liedetection.jpg){fig-align="center"}

## Visual World Paradigm

![Amos et al., 2022](images/session_7/amos2022.png){fig-align="center"}

## Visual World Paradigm

![Corley, 2010](images/session_7/corley2010.png){fig-align="center"}
...
::: {.column width="50%"}
![Clifton et al., 2007](images/session_7/reading6.png){fig-align="center"}
...
![Staub et al., 2007](images/session_7/reading5.png){fig-align="center"}

## Reading

Separate table per AI.

![Frisson et al., 2017](images/session_7/reading4.png){fig-align="center"}

## Reading

Model output

![Frisson et al., 2017](images/session_7/reading3.png){fig-align="center"}
...
![Cop et al., 2017](images/session_7/reading2.png){fig-align="center"}
:::

::: {.column width="50%"}
![Drighe & Chan Seem, 2022](images/session_7/reading1.png){fig-align="center"}
:::
:::
...
::: aside
This, in fact, it's done when you're doing data wrangling, but we're discussing it here for the sake of flow.
:::

## Data analysis {.smaller}

Stimuli variables as covariate in analysis
...
-   Eye-tracking data might not be continuous.
    ...
    -   Work with generalised models to accomodate a different link function.

## Visual World Paradigm

-   Binary: Is there a fixation on this area of interest?
    -   Doesn't consider other areas.
    -   Depends on your RQ.
-   **Work with proportions**
    -   Bounded \[0, 1\]
    -   Transformation: Empirical logits (Barr, 2008): log(count of fixations + .5 / (N - count of fixations + .5))
        -   Where N will be the number of samples per bin (when working with time binning anlaysis)
    -   Other authors have proposed different transformations.
    -   Some might still argue is not ideal (alternative: beta distribution?)


## Visual World Paradigm

Visualization of proportions versus empirical logits

## Visual World Paradigm

Note that it can also be minus saccades and blinks
...
etdat <-  etdat %>%
  mutate(
    target_FixCount = case_when(
      IA_1_ID == "1: TARGET" ~ `RIGHT_IA_1_SAMPLE_COUNT`,
...
Example of average empirical logit on a time window: Dijkgraaf et al., 2017
...
::: {.column width="50%"}
![](images/session_7/1.png){fig-align="center"} ![](images/session_7/2.png){fig-align="center"}
:::
:::
...
::: {.column width="50%"}
![](images/session_7/3.png){fig-align="center"}
...
![](images/session_7/4.png){fig-align="center"} ![](images/session_7/5.png){fig-align="center"}

## Visual World Paradigm

If you are only interested in whether there is an effect or not over time, a (generalised) linear mixed model, you would be fine (yet cf. assumptions of models).
...
![](images/session_7/9.png){fig-align="center"}
