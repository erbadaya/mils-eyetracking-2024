...
-   Slides
-   Template scripts in OpenSesame
...
| Day 2 |       Visual World Paradigm       | Experimental design .pdf, RR_1, OpenSesame |
| Day 3 |              Reading              |              RR_2, OpenSesame              |
| Day 4 | Lab session & Data pre-processing |            DataViewer, datasets            |
...
-   Space with respect to our eyes that we can perceive.
...
-   The [validity of results]{.fg style="--col: #e64173"} based on eye movement analysis are clearly dependent on the quality of eye movement data (Holmqvist et al., 2011)
...
::: {layout-ncol="2"}
![King et al., 2018](images/session_1/mt_1.png){fig-align="center" height="500px"}
...
::: {.column width="50%"}
![](images/session_1/example_loy2017.JPG)
:::
:::
...
::: columns
::: {.column width="50%"}
{{< video images/session_1/fluent-native.mp4 height="400" >}}
:::

::: {.column width="50%"}
{{< video images/session_1/disfluent-native.mp4 height="400" >}}
:::
:::
...
::: {layout-ncol="2"}
![](images/session_1/reading_resultsV.png){fig-align="center" height="350px"}

![](images/session_1/reading_resultsINF.png){fig-align="center" height="350px"}
:::
