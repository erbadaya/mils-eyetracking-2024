...
Analysis per region (area of interest)!

## Reading

-   Multiple regions of interest
-   Multiple dependent measures --\> correct for multiple comparisons!

Not standard yet although should be (von der Malsburg & Angele, 2017).

Bonferroni (most conservative), Holm-Bonferroni...

-   6 measures for target IA --\> $\alpha$ / 6 --\> 0.05 / 6
