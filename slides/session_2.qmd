...
Example: Manner of delivery (fluent/disfluent) biasing interpretations of deceit (Loy et al., 2017)

-   DV: Fixations on either item on the screen.
-   IV: Manner of delivery

2-images visual array (target v distractor)
...
-   8 images (4 pairs, because we have 4 trials)
-   8 audios (4 carrier sentences, 4 nouns, to ease sending triggers)
...
-   We want participants to only be able to click for 5000 ms.
...
-   We want two areas of interest (target versus distractor).
    -   Dynamic values!
...
![](images/session_2/loopvwp.png)

## Building a VWP experiment

The trial sequence

![](images/session_2/trialsequencevwp.png)

## Building a VWP experiment

Send Areas of Interest - inline python script

![](images/session_2/inlinescript1.png)

## Building a VWP experiment

Dynamic visual stimuli

![](images/session_2/canvas1.png)
...
![](images/session_2/audio1.png)

:::
:::{.column width="40%"}

![](images/session_2/audio2.png)
...
Send triggers - inline python script
